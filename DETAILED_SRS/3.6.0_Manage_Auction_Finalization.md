...
| :------- | :-------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **(5)**  | **BR-01** | **Displaying Rule:**<br>The system displays an "**Auction Finalization Management**" screen. (Refer to "**Auction Finalization Management**" view in "View Description" file). |
