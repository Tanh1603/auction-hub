...
| :------- | :-------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **(4)**  | **BR-01** | **Displaying Rules:**<br>❖ The system displays an “AuthenticationPage” screen. (Refer to “Authentication” view in “View Description” file).<br>❖ The system renders buttons for key authentication actions: [Login], [Register], and [Forgot Password].                                                                                                                                                                                                  |
| **(5)**  | **BR-02** | **Choosing Rules:**<br>❖ The Guest or User selects an authentication function. The system uses `Frontend_Navigation()` to handle redirection.<br>❖ If “Register” is selected, the system redirects to the account registration workflow (Ref: `3.2.1`).<br>❖ If “Login” is selected, the system redirects to the user login workflow (Ref: `3.2.2`).<br>❖ If “Forgot Password” is selected, the system redirects to the password recovery workflow (Ref: `3.2.3`).<br>❖ If “Resend Verification” is selected, the system redirects to the email verification resend workflow (Ref: `3.2.4`).<br>❖ The User can only choose one feature at a time. |
