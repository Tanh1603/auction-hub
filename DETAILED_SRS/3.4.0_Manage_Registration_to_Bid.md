...
| :------- | :-------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **(5)**  | **BR-01** | **Displaying Rules:**<br>❖ The system displays a “RegistrationManagementPage” screen. (Refer to “Registration to Bid Management” view in “View Description” file).<br>❖ The system calls `RegisterToBidController.findAll()` to retrieve registration data.<br>❖ A datagrid is rendered with columns: [AuctionCode], [BidderName], [Status], and [SubmittedAt].                                                                                                                                                                                                                                                                |
| **(6)**  | **BR-02** | **Choosing Rules:**<br>❖ The Bidder or Admin selects a registration management function. The system uses `Frontend_Navigation()` to handle redirection.<br>❖ If “Register” is selected, the system redirects to `3.4.1`.<br>❖ If “Withdraw” is selected, it redirects to `3.4.2`.<br>❖ If “Check-in” is selected, the system initiates `3.4.3`.<br>❖ If “Submit Deposit” is selected, it redirects to `3.4.4`.<br>❖ If “Verify Deposit” is selected, it redirects to `3.4.5`.<br>❖ If “View Own” is selected, it redirects to `3.4.6`.<br>❖ If “Get for Auction” is selected, it redirects to `3.4.7`.<br>❖ If “List All (Admin)” is selected, it redirects to `3.4.8`.<br>❖ If “Approve (Legacy)” is selected, it redirects to `3.4.9`.<br>❖ If “Reject” is selected, it redirects to `3.4.10`.<br>❖ If “Verify Docs” is selected, it redirects to `3.4.11`.<br>❖ If “Reject Docs” is selected, it redirects to `3.4.12`.<br>❖ If “Final Approval” is selected, it redirects to `3.4.13`.<br>❖ Only one feature can be selected at a time. |
