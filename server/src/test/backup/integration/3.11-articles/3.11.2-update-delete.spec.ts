/**
 * Integration Tests for 3.11.4-6 Articles Update, Relations, and Delete
 * Test Case IDs: TC-3.11.4-01 to TC-3.11.6-03
 */
...
describe('3.11.4-6 Articles Update, Relations, Delete', () => {
  ...
  // ============================================
  describe('3.11.4 Update Article', () => {
    it('TC-3.11.4-01: Verify update article title', async () => {
    ...
    it('TC-3.11.4-02: Verify update article content', async () => {
      await request(app.getHttpServer())
        .put(`/api/articles/${article1.id}`)
        .set('Authorization', `Bearer ${adminToken}`)
        .send({
    ...
    it('TC-3.11.4-03: Verify update article type', async () => {
      await request(app.getHttpServer())
        .put(`/api/articles/${article1.id}`)
        .set('Authorization', `Bearer ${adminToken}`)
        .send({
    ...
    it('TC-3.11.4-04: Fail update non-existent article', async () => {
      await request(app.getHttpServer())
  ...
  // ============================================
  // 3.11.5 Article Relations
  // ============================================
  describe('3.11.5 Article Relations', () => {
    it('TC-3.11.5-01: Verify update article relations', async () => {
    ...
    it('TC-3.11.5-02: Verify replace article relations', async () => {
    ...
    it('TC-3.11.5-03: Verify clear all relations', async () => {
    ...
    it('TC-3.11.5-04: Fail relation with self', async () => {
      const response = await request(app.getHttpServer())
        .patch(`/api/articles/${article1.id}/relations`)
        .set('Authorization', `Bearer ${adminToken}`)
  ...
  // ============================================
  describe('3.11.6 Delete Article', () => {
    it('TC-3.11.6-01: Verify delete article', async () => {
      await request(app.getHttpServer())
    ...
    it('TC-3.11.6-02: Fail delete non-existent article', async () => {
      await request(app.getHttpServer())
    ...
    it('TC-3.11.6-03: Verify delete removes related records', async () => {
      await prisma.articleRelation.create({
        data: { articleId: article1.id, relatedArticleId: article2.id },
      });
