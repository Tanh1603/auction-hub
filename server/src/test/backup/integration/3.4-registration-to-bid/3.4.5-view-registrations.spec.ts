/**
 * Integration Tests for 3.4.6-8 Registration Viewing
 * Test Case IDs: TC-3.4.6-01 to TC-3.4.8-05
 */
...
describe('3.4.6-8 Registration Viewing', () => {
  ...
  // ============================================
  describe('3.4.6 View Own Registrations', () => {
    it('TC-3.4.6-01: Verify bidder views own registrations', async () => {
    ...
    it('TC-3.4.6-02: Fail view other users registrations as bidder', async () => {
      const response = await request(app.getHttpServer())
        .get(`/api/register-to-bid/users/${bidder1.id}/registrations`)
    ...
    it('TC-3.4.6-03: Verify Admin can view any users registrations', async () => {
      const response = await request(app.getHttpServer())
        .get(`/api/register-to-bid/users/${bidder1.id}/registrations`)
    ...
    it('TC-3.4.6-04: Verify empty list for user with no registrations', async () => {
      const response = await request(app.getHttpServer())
  ...
  // ============================================
  describe('3.4.7 Get Registration for Auction', () => {
    it('TC-3.4.7-01: Verify get registration for specific auction', async () => {
      const response = await request(app.getHttpServer())
    ...
    it('TC-3.4.7-02: Return 404 for non-registered auction', async () => {
      const response = await request(app.getHttpServer())
        .get(`/api/register-to-bid/auctions/${auction.id}/registration`)
        .set('Authorization', `Bearer ${bidder2Token}`)
        .expect(404);
    ...
    it('TC-3.4.7-03: Fail without authentication', async () => {
  ...
  // ============================================
  // 3.4.8 Admin List Registrations
  // ============================================
  describe('3.4.8 Admin List Registrations', () => {
    it('TC-3.4.8-01: Verify Admin lists all registrations', async () => {
      const response = await request(app.getHttpServer())
    ...
    it('TC-3.4.8-02: Verify filter by status', async () => {
      const response = await request(app.getHttpServer())
    ...
    it('TC-3.4.8-03: Verify filter by auctionId', async () => {
      const response = await request(app.getHttpServer())
    ...
    it('TC-3.4.8-04: Fail Bidder accessing admin registrations', async () => {
      const response = await request(app.getHttpServer())
        .get('/api/register-to-bid/admin/registrations')
        .set('Authorization', `Bearer ${bidder1Token}`)
        .expect(403);
