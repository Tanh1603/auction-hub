/**
 * Integration Tests for 3.5.2 Bid Denial
 * Test Case IDs: TC-3.5.2-01 to TC-3.5.2-10
 *
...
describe('3.5.2 Bid Denial', () => {
  ...
  describe('Successful Denial', () => {
    it('TC-3.5.2-01: Verify Admin denies bid with reason', async () => {
    ...
    it('TC-3.5.2-02: Verify Auctioneer denies bid', async () => {
      const response = await request(app.getHttpServer())
        .post('/api/manual-bid/deny')
  ...
  describe('Denial Failures', () => {
    it('TC-3.5.2-03: Fail Bidder denies bid', async () => {
      const response = await request(app.getHttpServer())
        .post('/api/manual-bid/deny')
    ...
    it('TC-3.5.2-04: Fail deny non-existent bid', async () => {
      const response = await request(app.getHttpServer())
        .post('/api/manual-bid/deny')
        .set('Authorization', `Bearer ${adminToken}`)
    ...
    it('TC-3.5.2-05: Fail deny already denied bid', async () => {
    ...
    it('TC-3.5.2-06: Fail deny with missing reason', async () => {
      const response = await request(app.getHttpServer())
        .post('/api/manual-bid/deny')
        .set('Authorization', `Bearer ${adminToken}`)
  ...
  describe('Winner Promotion', () => {
    it('TC-3.5.2-07: Verify next highest bid promoted when winning denied', async () => {
  ...
  describe('Authentication', () => {
    it('TC-3.5.2-08: Fail denial without authentication', async () => {
      const response = await request(app.getHttpServer())
        .post('/api/manual-bid/deny')
        .send({ bidId: winningBid.id, reason: 'Test' })
        .expect(401);
