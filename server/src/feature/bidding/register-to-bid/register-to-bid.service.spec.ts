...
// import { BidRegistrationStatus } from '../../../../generated';
...
//           jest
//             .spyOn(prismaService.registerToBid, 'create')
...
//       await expect(
//         service.create(mockCreateDto, mockUser as any)
...
//           jest
//             .spyOn(prismaService.registerToBid, 'delete')
...
//       await expect(
//         service.getRegistrationStatusForAdmin(mockUser.id)
//       ).rejects.toThrow(NotFoundException);
//     });
//   });
// });
