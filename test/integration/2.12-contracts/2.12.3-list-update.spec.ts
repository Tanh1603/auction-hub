/**
 * Integration Tests for 2.12.3-4 List and Update Contracts
 * Test Case IDs: TC-2.12.3-01 to TC-2.12.4-02
 */
...
describe('2.12.3-4 List and Update Contracts', () => {
  ...
  // ============================================
  describe('2.12.3 List Contracts', () => {
    it('TC-2.12.3-01: Verify list user contracts', async () => {
    ...
    it('TC-2.12.3-02: Verify empty list when no contracts', async () => {
  ...
  // ============================================
  describe('2.12.4 Update Contract', () => {
    it('TC-2.12.4-01: Verify update contract status', async () => {
      const response = await request(app.getHttpServer())
    ...
    it('TC-2.12.4-02: Fail Bidder updating contract', async () => {
      const response = await request(app.getHttpServer())
        .patch(`/api/contracts/${contract.id}`)
        .set('Authorization', `Bearer ${buyerToken}`)
        .send({ status: 'signed' });
      ...
      // - 403 if only admin can update contracts
      // - 200 if buyer (as contract party) is allowed to update status
