/**
 * Integration Tests for 3.4.9-13 Admin Registration Operations
 * Test Case IDs: TC-3.4.9-01 to TC-3.4.13-04
 */
...
describe('3.4.9-13 Admin Registration Operations', () => {
  ...
  // ============================================
  // 3.4.9 Approve Registration
  // ============================================
  describe('3.4.9 Approve Registration', () => {
    it('TC-3.4.9-01: Verify Admin approves registration', async () => {
    ...
    it('TC-3.4.9-02: Fail approve already approved', async () => {
    ...
    it('TC-3.4.9-03: Fail approve withdrawn registration', async () => {
      await prisma.auctionParticipant.update({
        where: { id: registration.id },
    ...
    it('TC-3.4.9-04: Fail approve non-existent registration', async () => {
      await request(app.getHttpServer())
        .post('/api/register-to-bid/admin/approve')
        .set('Authorization', `Bearer ${adminToken}`)
  ...
  // ============================================
  describe('3.4.10 Reject Registration', () => {
    it('TC-3.4.10-01: Verify Admin rejects registration with reason', async () => {
      const response = await request(app.getHttpServer())
    ...
    it('TC-3.4.10-02: Verify reject without reason (optional)', async () => {
      const response = await request(app.getHttpServer())
        .post('/api/register-to-bid/admin/reject')
        .set('Authorization', `Bearer ${adminToken}`)
        .send({ registrationId: registration.id });
    ...
    it('TC-3.4.10-03: Fail reject already confirmed registration', async () => {
      await prisma.auctionParticipant.update({
        where: { id: registration.id },
        data: { confirmedAt: new Date() },
      });
  ...
  // ============================================
  describe('3.4.11 Verify Documents', () => {
    it('TC-3.4.11-01: Verify Admin verifies documents', async () => {
      const response = await request(app.getHttpServer())
    ...
    it('TC-3.4.11-02: Fail verify documents without submission', async () => {
      await prisma.auctionParticipant.update({
        where: { id: registration.id },
        data: { documents: null },
      });
    ...
    it('TC-3.4.11-03: Fail verify already verified', async () => {
      await prisma.auctionParticipant.update({
        where: { id: registration.id },
  ...
  // ============================================
  describe('3.4.12 Reject Documents', () => {
    it('TC-3.4.12-01: Verify Admin rejects documents with reason', async () => {
      const response = await request(app.getHttpServer())
    ...
    it('TC-3.4.12-02: Fail reject documents without reason', async () => {
      await request(app.getHttpServer())
        .post('/api/register-to-bid/admin/reject-documents')
        .set('Authorization', `Bearer ${adminToken}`)
        .send({ registrationId: registration.id })
  ...
  // ============================================
  describe('3.4.13 Final Approval', () => {
    it('TC-3.4.13-01: Verify Admin final approval', async () => {
      await prisma.auctionParticipant.update({
        where: { id: registration.id },
        data: {
    ...
    it('TC-3.4.13-02: Fail final approval without document verification', async () => {
      await prisma.auctionParticipant.update({
        where: { id: registration.id },
        data: {
          depositPaidAt: createDate(-1),
    ...
    it('TC-3.4.13-03: Fail final approval without deposit payment', async () => {
      await prisma.auctionParticipant.update({
        where: { id: registration.id },
    ...
    it('TC-3.4.13-04: Fail final approval already confirmed', async () => {
      await prisma.auctionParticipant.update({
        where: { id: registration.id },
        data: {
          documentsVerifiedAt: createDate(-1),
