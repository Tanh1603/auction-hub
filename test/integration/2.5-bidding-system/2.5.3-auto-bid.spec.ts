/**
 * Integration Tests for 2.5.3 Auto-Bid
 * Test Case IDs: TC-2.5.3-01 to TC-2.5.3-08
...
describe('2.5.3 Auto-Bid', () => {
  ...
  describe('Configure Auto-Bid', () => {
    it('TC-2.2.4-01: Verify set auto-bid max amount', async () => {
    ...
    it('TC-2.2.4-01: Verify update auto-bid max amount', async () => {
      const response = await request(app.getHttpServer())
        .post('/api/auto-bid/configure')
        .set('Authorization', `Bearer ${bidderToken}`)
        .send({
    ...
    it('TC-2.2.2-01: Verify disable auto-bid', async () => {
      const response = await request(app.getHttpServer())
        .post('/api/auto-bid/configure')
        .set('Authorization', `Bearer ${bidderToken}`)
        .send({
  ...
  describe('Auto-Bid Failures', () => {
    it('TC-2.5.1-06: Fail auto-bid max below current price', async () => {
      ...
      const response = await request(app.getHttpServer())
        ...
        .send({
          auctionId: liveAuction.id,
          maxamount: 11000000, // Below current bid
          isActive: true,
        });
    ...
    it('TC-2.5.1-07: Fail auto-bid without check-in', async () => {
    ...
    it('TC-2.5.1-11: Fail auto-bid on closed auction', async () => {
